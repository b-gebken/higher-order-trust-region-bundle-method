% Script that performs the experiment in Example 5.3 and creates the plot
...
legend([h1,h4,h2],{'$\| x^{j,i} - x^* \|$', '$\| x^j - x^* \|$', '$\Delta_j$'},'Interpreter','latex','FontSize',19,'Location','sw');
